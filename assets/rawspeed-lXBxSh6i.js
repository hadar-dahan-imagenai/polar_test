...
(function() {
        try {
            ...
            B && (F._sentryDebugIds = F._sentryDebugIds || {},
                F._sentryDebugIds[B] = "cc4803b2-8411-4795-a33e-81e24e876f23",
                F._sentryDebugIdIdentifier = "sentry-dbid-cc4803b2-8411-4795-a33e-81e24e876f23")
        } catch {}
    }
)();
...
var da = ( () => {
        ...
        return async function(B={}) {
            ...
            var Z = l.wasmBinary, w, Br, J = !1, N, M, Nr, Lr, Dr, Gr, zr, Yr, I, Kr, Xr, qr = !1;
            function z() {
                return w.buffer != M.buffer && P(),
                    M
            }
            ...
            var ae = a(r => {
                ...
                , le = a( () => cn(), "stackSave")
                , wr = a(r => ln(r), "stackRestore")
                , br = a(r => vn(r), "stackAlloc")
                , Wn = 9007199254740992
                , Pn = -9007199254740992
                , Rn = a(r => r < Pn || r > Wn ? NaN : Number(r), "bigintToI53Checked")
                , T = a( (r, e, n, ...t) => {
                    for (var i = t.length * 2, f = le(), o = br(i * 8), s = o >> 3, u = 0; u < t.length; u++) {
                        var v = t[u];
            ...
            var In = a( () => typeof SharedArrayBuffer < "u", "_emscripten_has_threading_support")
                ...
                , we = typeof TextDecoder < "u" ? new TextDecoder : void 0
                , be = a( (r, e=0, n=NaN) => {
                    for (var t = e + n, i = e; r[i] && !(i >= t); )
                        ++i;
                    if (i - e > 16 && r.buffer && we)
                        return we.decode(r.buffer instanceof ArrayBuffer ? r.subarray(e, i) : r.slice(e, i));
                    for (var f = ""; e < i; ) {
                        var o = r[e++];
                        if (!(o & 128)) {
                ...
                , "UTF8ArrayToString")
                , nr = a( (r, e) => r ? be(E(), r, e) : "", "UTF8ToString");
            function Te(r, e, n) {
...
` + i.replace(/^Error(:[^\n]*)?\n/, ""))
                ...
                return Function
            }()("return this")(), "emval_get_global"), Pt = a(r => r === 0 ? b.toHandle(Ve()) : (r = je(r),
                b.toHandle(Ve()[r])), "__emval_get_global"), Rt = a(r => {
                    var e = Pr.length;
                    return Pr.push(r),
                        e
                }
                ...
                , "emval_lookupTypes"), Ct = a( (r, e, n) => {
                    var t = []
                        , i = r.toWireType(t, n);
                    return t.length && (g()[e >> 2] = b.toHandle(t)),
                        i
                }
...
`,
                ...
                , "__emval_incref"), $t = a( () => b.toHandle([]), "__emval_new_array"), It = a(r => {
                    r = b.toValue(r);
                    for (var e = new Array(r.length), n = 0; n < r.length; n++)
                        e[n] = r[n];
                    return b.toHandle(e)
                }
                , "__emval_new_array_from_memory_view"), Ut = a(r => b.toHandle(je(r)), "__emval_new_cstring"), Ht = a( () => b.toHandle({}), "__emval_new_object"), Ot = a(r => {
                    var e = b.toValue(r);
                    Ar(e),
                        kr(r)
                }
...
_a && da();
//# sourceMappingURL=rawspeed-lXBxSh6i.js.map
